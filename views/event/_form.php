...
<div class="event-form well">
    ...
    foreach ($this->params[EventController::SENSORS_DATA] as $sensor) {
        $sensorsLabels[$sensor[EventController::SENSOR_DATA_URI]] = $sensor[EventController::SENSOR_DATA_LABEL];
    }
    ?>
    <?=
    ...
    ?>
    <?=
    $form->field($model, EventCreation::PROPERTY_POSITION)->textInput([
        'maxlength' => true
    ]);
    ?>
    <?php
    ...
    <script>
        ...
        var positionDiv = $('div[class*="propertyposition"]');
        ...
        var positionSelect = positionDiv.find(selectClass);
        ...
        positionSelect.on('change', function (e) {
            setPropertyType(positionSelect.val());
        });
            ...
            typeSelect.on('change', function () {
                switch (this.value) {
                    ...
                    case "http://www.opensilex.org/vocabulary/oeev#AssociatedToASensor":
                        ...
                        positionDiv.hide();
                        break;
                    case "http://www.opensilex.org/vocabulary/oeev#Installation":
                        hasPestDiv.hide();
                        fromDiv.hide();
                        toDiv.hide();
                        associateToASensorDiv.hide();
                        ...
                        break;
                    default:
                        hidePropertyBlocs(hasPestDiv, fromDiv, toDiv, associateToASensorDiv, positionDiv);
                        break;
                }
            });
        }
