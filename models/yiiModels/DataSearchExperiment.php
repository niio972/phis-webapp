 ...
 */
class DataSearchExperiment extends YiiDataModel {
    ...
    public function __construct($pageSize = null, $page = null) {
        $this->wsModel = new \app\models\wsModels\WSExperimentModel();
    ...
    /**
     * Label of the experiment of the data.
     * @var string
     */
    ...
    {
        return [
            [['variable','experiment'],'required'],
            [['variable', 'startDate', 'endDate', 'object', 'objectLabel', 'provenance', 'provenanceLabel','experiment','experimentLabel'], 'safe'],
        ];
    }
