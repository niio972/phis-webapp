...
return [
    ...
    'To create a new provenance, write the provenance label in the research field and press `Enter`. After you will be able to fill provenance input fields and create it by press `Create provenance` button. E.g: PROV-SUA3-LAV-2020 (PROV-{Project}{Installation}{Year}-(Optional){Operator acronym, ...} ' => 'Pour créer une nouvelle provenance, écrivez le nom de votre nouvel provenance puis appuyer sur la touche `Entrée`. Vous pourrez ainsi compléter votre nouvelle provenance et cliquer sur le bouton `Créer la provenance`. Ex: PROV-SUA3-LAV-2020 (PROV-{Projet}{Installation}{Année}-(Optionnel){Acronyme de l\'opérateur, ...} ',
